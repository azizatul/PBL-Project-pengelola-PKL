...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="{{ route('mahasiswa.index') }}"><i class="fas fa-user-friends"></i>Data Mahasiswa</a></li>
                 <li><a href="{{ route('transkip-nilai.index') }}"><i class="fas fa-file-pdf"></i>Data Transkip Nilai</a></li>
            <li><a href="{{ route('proposal.index') }}"><i class="fas fa-star"></i> Data Proposal</a></li>
            <li>
            ...
            <div class="right-section">
                <div class="user-info">
                    ...
                    <div class="user-details">
                        <div class="user-name">Kaprodi TI</div>
        ...
        <div class="content-body">
            <div class="stats-cards">
                ...
                <div class="card green">
                    ...
                    <div class="card-content">
                        <div class="card-title">Perusahaan Mitra</div>
                        <div class="card-value">3</div>
                    </div>
                </div>
            ...
            <div class="recent-list">
                <h2>Mahasiswa PKL Aktif</h2>
                <table>
                    <thead>
                        <tr>
                            <th>NIM</th>
                            <th>Nama Mahasiswa</th>
                            <th>KHS/Kartu Studi</th>
                            <th>DPL/Uji</th>
                            <th>Opsi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td colspan="5" style="text-align: center; color: #666;">Belum ada data mahasiswa PKL</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="recent-list" style="margin-top: 30px;">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="5" style="text-align: center; color: #666;">Belum ada jadwal seminar</td>
                        </tr>
                    </tbody>
                </table>
            </div>
